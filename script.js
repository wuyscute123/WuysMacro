...
// Auto-enter after 5s if user doesn't click
setTimeout(() => {
...
// ---- SCROLL REVEAL ----
const reveals = document.querySelectorAll('.feature-card, .about-grid, .section-title, .section-label, .demo-frame, .demo-cta, .about-card, .hero-stats, .footer-grid');
...
// ---- VIDEO FALLBACK ----
// Show placeholder text if video fails
